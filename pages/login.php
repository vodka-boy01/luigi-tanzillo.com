...
<body>
  ...
  if(isset($_POST['invia'])){
    ...
    }else if(!$userOperations->verifyPassword($username, $password)){
  ...
  <main class="login-container">
    ...
    <form action="<?php $_SERVER['PHP_SELF']?>" method="post" id="form">
      <div>
        ...
        <input type="text" id="username" name="username" placeholder="Username" required class="<?php if(isset($error) && $error != ''){echo "error_border";}?>">
      </div>

      <div>
        <label for="password">Password:</label>
        <input type="password" id="password" name="password" placeholder="Passoword" required class="<?php if(isset($error) && $error != ''){echo "error_border";}?>">
      </div>
      ...
      <input type="submit" name="invia" value="Accedi" class="button primary">
    </form>
